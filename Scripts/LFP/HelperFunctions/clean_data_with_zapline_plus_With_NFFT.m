...
% NeuroImage, 1, 1-13.
% Adapted by Hardstone, R. to allow nfft to be set as a parameter
%
% Usage:
%
...
%   nfft                            - number of FFT points used for Zapline, should be power of 2 (default = 1024)
...
function [cleanData, zaplineConfig, analyticsResults, plothandles] = clean_data_with_zapline_plus_With_NFFT(data, srate, varargin)
...
disp('Human Brain Mapping,1â€“16. https://doi.org/10.1002/hbm.25832')
disp(' ')
disp('-------------------- AND ---------------------')
disp(' ')
...
%%RHardstoneAddition_2023_06_04
addOptional(p, 'nfft', 1024, @(x) validateattributes(x,{'numeric'},{'positive','scalar'},'clean_EEG_with_zapline','nFFT')) %%RHardstoneAddition_2023_06_04
...
nfft = p.Results.nfft;  %%RHardstoneAddition_2023_06_04
...
zaplineConfig.nfft = nfft;  %%RHardstoneAddition_2023_06_04
...
if strcmp(noisefreqs,'line')
    ...
    % SchÃ¤fer et al. (2018). Non-Gaussian power grid
    % frequency fluctuations characterized by LÃ©vy-stable laws and superstatis-
